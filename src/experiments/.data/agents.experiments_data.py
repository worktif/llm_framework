...
# Define example queries and responses
queries = [
...
save_to_json(output_folder_experiment_data, "agent_data", agent_data)
...
save_to_json(output_folder_experiment_data, "agent_deviations", agent_deviations)
